...
namespace A4LGSharedFunctions
{
    ...
    public static class Globals
    {
        ...
        public static IFeatureLayer copyClassToInMemory(IFeatureClass sourceClass, string className, string layerName, IMap map, IGroupLayer groupLayer, bool lookForLayer, string IDFieldName)
        {
            ILayer pLay = null;
            IFields pFlds = null;
        ...
        public static string getClassName(IDataset Dataset)
        {
            ...
            else if (Dataset.FullName.NameString != "" && Dataset.FullName.NameString.Contains("."))
                return Dataset.FullName.NameString.Substring(Dataset.FullName.NameString.LastIndexOf(".") + 1);
            else if (Dataset.Name != "" && Dataset.Name.Contains("."))
                return Dataset.Name.Substring(Dataset.Name.LastIndexOf(".") + 1);

            else if (Dataset.BrowseName != "")

                return Dataset.BrowseName;
            else if (Dataset.FullName.NameString != "")
        ...
        public static IFields createFeatureClassFields(ISpatialReference pSpatRef, esriGeometryType GeoType, string IDFieldName)
        {
            ...
            try
            {
                ...
                pFields = Globals.copyFields(pFields, null, null, IDFieldName);
        ...
        public static IFeatureClass createFeatureClassInMemory(string strName, IFields FeatureFields, IWorkspace pWS, esriFeatureType featType)
        {
            ...
            try
            {
                ...
                {
                    featType = esriFeatureType.esriFTSimpleEdge;
                }
                if (featType == esriFeatureType.esriFTComplexJunction)
                {
                    featType = esriFeatureType.esriFTSimpleJunction;
                }
        ...
        public static IFields copyFields(IFields SourceFields, IField lenFld, IField areaField, string IDFieldName)
        {
            // create fields
            IFields pFields = null;
